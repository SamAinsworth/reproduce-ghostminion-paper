...
$BASE/gem5/build/ARM/gem5.opt $BASE/gem5/configs/example/se.py  -c "$1" -o "$2" -i "$3" --caches --l2cache --cpu-type=DerivO3CPU   --maxinsts=1000000000 --fast-forward=1000000000  --mem-size=2048MB --ghostminion --cache_coher --iminion --prefetch_ordered ; mv m5out/stats.txt m5out/statsminion2kall.txt
$BASE/gem5/build/ARM/gem5.opt $BASE/gem5/configs/example/se.py  -c "$1" -o "$2" -i "$3" --caches --l2cache --cpu-type=DerivO3CPU  --maxinsts=1000000000 --fast-forward=1000000000 --mem-size=2048MB; mv m5out/stats.txt m5out/statsno.txt
